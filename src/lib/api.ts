 ...
 *
 * The backend returns this as a single JSON response, not a stream — despite
 * the name, there's no `progress`/`complete` event contract here.
 */
...
/** The backend returns this as a single JSON response, not a stream. */
